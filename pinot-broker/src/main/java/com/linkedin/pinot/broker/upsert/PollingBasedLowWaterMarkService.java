...
public class PollingBasedLowWaterMarkService implements LowWaterMarkService {
    ...
    private class PinotServerPollingExecutor implements Runnable {
        ...
        private URI getURI(String host, String port) throws URISyntaxException {
            return new URI(PollingBasedLowWaterMarkService.HTTP, null, host, Integer.valueOf(port), null
                    , null, null);
        }
    }
