...
public final class Schema {
  ...
  private static final String UPSERT_TABLE_CONFIG_KEY = "upsert";
  @JsonIgnore
  ...
  public boolean isTableForUpsert() {
    return UPSERT_TABLE_CONFIG_KEY.equalsIgnoreCase(_updateSemantic);
  }
  ...
  public void withSchemaHint(@Nullable Schema upsertSchema) {
    if (upsertSchema == null || !upsertSchema.isTableForUpsert()) {
      ...
      this._updateSemantic = UPSERT_TABLE_CONFIG_KEY;
  ...
  public ObjectNode toJsonObject() {
    ...
    if (UPSERT_TABLE_CONFIG_KEY.equalsIgnoreCase(_updateSemantic)) {
