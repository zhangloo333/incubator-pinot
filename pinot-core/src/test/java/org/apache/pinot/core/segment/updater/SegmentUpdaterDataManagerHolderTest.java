...
public class SegmentUpdaterDataManagerHolderTest {
  ...
  private UpsertSegmentDataManager dummyManager1;
  private UpsertSegmentDataManager dummyManager2;
  private UpsertSegmentDataManager dummyManager3;

  @BeforeMethod
  public void setUp() {
    emptyHolder = new SegmentUpdaterDataManagerHolder();
    dataManagerHolder = new SegmentUpdaterDataManagerHolder();
    dummyManager1 = mock(UpsertSegmentDataManager.class);
    dummyManager2 = mock(UpsertSegmentDataManager.class);
    dummyManager3 = mock(UpsertSegmentDataManager.class);
  ...
  public void testGetDataManagers() {
    Set<UpsertSegmentDataManager> dataManagers = dataManagerHolder.getDataManagers("table", "segment1");
  ...
  public void testAddDataManager() {
    UpsertSegmentDataManager dummyManager4 = mock(UpsertSegmentDataManager.class);
    UpsertSegmentDataManager dummyManager5 = mock(UpsertSegmentDataManager.class);
    UpsertSegmentDataManager dummyManager6 = mock(UpsertSegmentDataManager.class);
    ...
    Set<UpsertSegmentDataManager> tableSegmentDMs = dataManagerHolder.getDataManagers("table", "segment1");
  ...
  public void testRemoveDataManager() {
    ...
    dataManagerHolder.addDataManager("table", "segment2", dummyManager5);
    dataManagerHolder.addDataManager("table2", "segment1", dummyManager6);
    Set<UpsertSegmentDataManager> tableSegmentDMs;
